    ...
    <SlideContainer id="projects-comparison" variant="default">
      ...
      <div className="mt-8 space-y-8 max-w-3xl mx-auto">
        ...
        <AnimatedText delay={0.3}>
          <div className="interactive-panel border-green-500/30 bg-green-500/5">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-green-500/20 flex items-center justify-center text-2xl flex-shrink-0">
                📊
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-2">Standardized Benchmarking</h3>
                <p className="text-gray-400 leading-relaxed mb-4">
                  Help build a{' '}
                  <span className="text-green-400 font-medium">standardized benchmarking framework</span> so
                  we can compare apples to apples across different EVM implementations.
                </p>
                <motion.a
                  href="https://github.com/ethereum/execution-specs"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 rounded-lg bg-green-500/20 hover:bg-green-500/30 text-green-400 font-medium transition-all inline-flex items-center gap-2 text-sm"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
